...
export const metadata: Metadata = {
  title: 'CoorgSource - Premium Coffee & Spice Sourcing from Coorg | Trade Facilitation Partner',
  ...
  authors: [{ name: 'CoorgSource' }],
  creator: 'CoorgSource',
  publisher: 'CoorgSource',
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  openGraph: {
    type: 'website',
    locale: 'en_IN',
    url: 'https://coorgsource.com',
    siteName: 'CoorgSource',
    title: 'CoorgSource - Premium Coffee & Spice Sourcing from Coorg',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'CoorgSource - Coffee & Spice Sourcing',
      },
    ],
  },
  twitter: {
